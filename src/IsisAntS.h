 ...
 * 	@return     The error status of the initialization, defined in SSerrors.h.
 */
 ...
 *	@param[in]  deploymentTime maximum deployment timeout of the activation.
 * 	@return     Error code according to <hal/errors.h>
 */
 ...
 *	@param[in]  side Antenna Systems side.
 *	@param[in]  antennaSelection obtain activation count from this selected antenna.
 *	@param[out] deploymentTime activation time of the selected antenna.
 * 	@return     Error code according to <hal/errors.h>
 */
